...
public class HDFSNameNodeCapacityUsageReportThread extends HDFSReportThread {
    ...
    public void work() {
        try {
            ...
            message.setMetricCode(MetricCode.P_HB_CLRDISK);
            message.setMetricType(MetricType.STATUS);
            message.setMetricValue(Float.toString(HDFSUtils.getCapacityUsageGB() * 100) + Constants.PERCENT);
