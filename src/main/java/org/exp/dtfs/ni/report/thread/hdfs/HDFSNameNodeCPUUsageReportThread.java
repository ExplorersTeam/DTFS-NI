...
public class HDFSNameNodeCPUUsageReportThread extends HDFSReportThread {
    ...
    public void work() {
        try {
            ...
            message.setMetricCode(MetricCode.P_HB_CLRCPU);
            message.setMetricType(MetricType.STATUS);
            message.setMetricValue(Float.toString(HDFSUtils.getCPUUsage() * 100) + Constants.PERCENT);
