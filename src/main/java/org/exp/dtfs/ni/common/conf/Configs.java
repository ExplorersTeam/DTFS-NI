...
public class Configs {
    ...
    static {
        ...
        addResources(HADOOP_CONF_MAIN_PATH_PARENT_KEY, HDFS_CONF_FILENAME);
        addResources(HBASE_CONF_PATH_PARENT_KEY, HBASE_CONF_FILENAME);
    }
    ...
    private static void addResources(String key, String... fileNames) {
        ...
        for (String fileName : fileNames) {
            CONF.addResource(path + (path.endsWith(Constants.SLASH_DELIMITER) ? "" : Constants.SLASH_DELIMITER) + fileName);
        }
    }
